...
describe User do
  ...
  describe 'password validation' do
    ...
    it 'should have a matching password confirmation' do
      wrong_confirmation = "notfoobar"
      wrong_confirmation_user = User.new(@attr.merge(:password_confirmation => wrong_confirmation ))
    ...
    describe 'password encryption' do
      ...
      it 'should respond to password encryption attribute' do
